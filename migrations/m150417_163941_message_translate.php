...
class m150417_163941_message_translate extends Migration
{
    /**
    ...
    public function up()
    {
        ...
        $this->addForeignKey('message_ibfk_1', 'message', ['language'], 'language', ['language_id'], 'CASCADE');
        $this->addForeignKey('message_ibfk_2', 'message', ['id'], 'source_message', ['id'], 'CASCADE');
