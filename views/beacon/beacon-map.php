...
<div class="row">
    <div class="col-md-9">
        ...
        <img id="img" src="/img/beacon_map.jpg" style="display: none">
...
<script>
    initSelect($('#beacon-pin'),
        "<?=Url::to(['not-pinned-beacon/get-selection-list'])?>","<?=Url::to(['not-pinned-beacon/get-selection-by-id'])?>",false,'100%');
