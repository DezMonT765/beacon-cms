...
/***/ function(module, exports, __webpack_require__) {
	...
	var _konva = __webpack_require__(1);
	
	var _konva2 = _interopRequireDefault(_konva);
	
	var _Brush = __webpack_require__(4);
	...
	var blackBrush = new _Brush2.default('#000');
	var whiteBrush = new _Brush2.default('#fff');
	...
	var brushes = function brushes() {
	    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [blackBrush, whiteBrush];
	    var action = arguments[1];
	...
	var store = exports.store = (0, _redux.createStore)(brushes, (0, _redux.applyMiddleware)(logger));
	var render = function render() {
	    console.log('render');
	    ReactDOM.render(_react2.default.createElement(App, { brushes: store.getState() }), document.getElementById('root'));
	};
	render();
...
//# sourceMappingURL=app.8c797836dbec6d0e3008.js.map