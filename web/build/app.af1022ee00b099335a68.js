...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Brush = __webpack_require__(11);
	...
	var brushes = function brushes() {
	    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { brushes: [new _Brush2.default('#000'), new _Brush2.default('#fff')], currentBrush: new _Brush2.default('#fff') };
	    var action = arguments[1];
	    ...
	    switch (action.type) {
	        case 'TOGGLE_BRUSH':
	            ...
	            new_state.brushes = [new _Brush2.default('#000'), new _Brush2.default('#fff')];
	...
	var BrushControls = function BrushControls(_ref) {
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            "button",
	            { onClick: _Canvas2.default.bind(null, store, nodeBuffer, idBuffer) },
	            "Clear"
	        )
	    );
	};
	...
	var App = function (_React$Component2) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function componentDidMount() {
	            (0, _Canvas2.default)(store, nodeBuffer, idBuffer);
	        }
	    }, {
	        key: "render",
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(BrushControls, { brushes: this.props.brushes, className: "col-md-2" })
	            );
	        }
	    }]);
	...
	var store = exports.store = (0, _redux.createStore)(brushes);
	var render = function render() {
	    ReactDOM.render(_react2.default.createElement(App, { brushes: store.getState().brushes }), document.getElementById('root'));
	};
	render();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _states = __webpack_require__(10);
	...
	var stage = null;
	function initCanvas(store, nodeBuffer, idBuffer) {
	    if (stage !== null) {
	        stage.destroy();
	    }
	    ...
	    var imageLayer = new _konva2.default.Layer();
	    var backgroundRect = new _konva2.default.Rect({
	        x: 0,
	        y: 0,
	        width: WIDTH * dimensionX,
	        height: HEIGHT * dimensionY
	    ...
	    var image = (0, _helper.makeImageRect)(backgroundRect, imageLayer);
	    stage.add(imageLayer);
	    image.src = '/img/background.jpg';
	
	    var grid = new _Grid2.default(stage, WIDTH, HEIGHT, dimensionX, dimensionY, cellPerLayer);
	    grid.build();
	    ...
	    stage.on('mouseover click mousedown', function (evt) {
	        if (store.getState().currentBrush.activated) {
	            ...
	            if (node) {
	                ...
	                var color = store.getState().currentBrush.color;
	    ...
	    setInterval(function () {
	        if (typeof Storage !== "undefined") {
	            var jsonRects = JSON.stringify(grid.rects);
	    ...
	    function undo(e) {
	        if (e.keyCode == 90 && e.ctrlKey) {
	            for (var i = 0; i < nodeBuffer.length; i++) {
	                var node = nodeBuffer[i].node;
	                var color = nodeBuffer[i].color;
	                node.fill(color);
	                grid.rects[node.x() / WIDTH][node.y() / HEIGHT] = color === '#000' ? states.WALL : states.EMPTY;
	                node.getLayer().batchDraw();
	            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Pin = __webpack_require__(7);
	...
	var Grid = function () {
	    function Grid(stage, width, height, dimensionX, dimensionY, cellPerLayer) {
	        ...
	        this._pin = new _Pin2.default(width, height, dimensionX, dimensionY, this.rects);
	    ...
	    _createClass(Grid, [{
	        ...
	        value: function build() {
	            var groupLayer = new _konva2.default.Layer();
	            var nodeCount = 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PIN_IMAGE_SRC = '/img/blue pin.svg';
	
	var Pin = function () {
	    function Pin(width, height, dimensionX, dimensionY, rects) {
	    ...
	    _createClass(Pin, [{
	        key: "add",
	        value: function add(groupLayer, x, y) {
	            var self = this;
	            this.counter++;
	            var group = new _konva2.default.Group({
	                draggable: true, dragBoundFunc: function dragBoundFunc(pos) {
	                    var x = Math.round(pos.x / self._width) * self._width;
	                    var y = Math.round(pos.y / self._height) * self._height;
	            ...
	            var beaconRect = new _konva2.default.Rect({
	                id: (0, _uuid.v4)(),
	                x: x,
	                y: y,
	                width: this._width,
	            ...
	            var beaconPinWidth = this._width * this._dimensionX * WIDTH_SCALE;
	            var beaconPinHeight = this._height * this._dimensionY * HEIGHT_SCALE;
	            var beaconPin = new _konva2.default.Rect({
	            ...
	            var beaconPinImage = (0, _helper.makeImageRect)(beaconPin, groupLayer);
	            beaconPinImage.src = PIN_IMAGE_SRC;
	            group.on('dragstart', function (e) {
	                e.cancelBubble = true;
	                var resultX = beaconRect.x() + group.x();
	                var resultY = beaconRect.y() + group.y();
...
/***/ function(module, exports) {
	...
	var PIN_COLOR = exports.PIN_COLOR = '#007FFF';
...
//# sourceMappingURL=app.af1022ee00b099335a68.js.map